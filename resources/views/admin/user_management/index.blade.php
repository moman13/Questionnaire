                                ...
                                @forelse  ($data as $i=>$user)
                                    ...
                                    <tr class="{{$i%2?'bg-gray-50':'bg-white'}}">
                                        ...
                                        <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500">
                                            {{$user->Role?$user->Role->name:'not assign'}}
                                        </td>
                                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                              <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{$user->getStatus()['class']}}  text-gray-800 ">
                                                {{$user->getStatus()['name']}}
                                              </span>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-no-wrap text-right text-sm leading-5 font-medium">
                                            ...
                                            <div class="inline-flex  items-center px-4 py-2  text-sm leading-5 font-medium rounded-md text-gray-700 ">
                                                ...
                                                <x-button_icon.edit wire:click="edit({{$user->id}})" />
                                                <x-button_icon.delete :object="$user" />
                                            </div>
